...
export default function CakesPage() {
  ...
  const filteredCakes = activeSubFilter === "all"
    ? cakes
    : cakes.filter((p) => p.subCategory === activeSubFilter);
  ...
  const handleSubscribe = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      showToast("You've subscribed to the secret menu! Watch your inbox for cake drop notifications.", "success");
      setEmail("");
  ...
  const featuredCake = {
    id: "featured-birthday",
    name: "Artisanal Birthday Cakes",
    price: 4500,
    category: "cakes" as const,
    description: "Celebrate life's milestones with our signature multi-layered floral designs, customized for every unique story.",
    image: "https://images.unsplash.com/photo-1663760888557-a93f08a02401?q=80&w=986&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    tags: ["Featured", "Floral", "Celebration"]
  };
    ...
    <>
      ...
      <PageWrapper>
        <header className="max-w-[800px] mx-auto px-margin-mobile md:px-margin-desktop pt-24 pb-16 text-center reveal">
          <h1 className="font-display text-4xl md:text-5xl text-primary mb-6">Artisanal Celebration Cakes</h1>
          <p className="font-body-lg text-body-lg text-on-surface-variant leading-relaxed">
            Designed for life&apos;s most precious milestones. Each cake is a unique masterpiece of flavor, form, and handcrafted details.
          </p>
        </header>
        ...
        <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop mb-16 reveal">
          <div className="relative group overflow-hidden rounded-2xl shadow-ambient bg-surface-container-low h-[450px] md:h-[600px] flex items-end">
            <div
              ...
              style={{ backgroundImage: `url(${featuredCake.image})` }}
            />
            ...
            <div className="relative p-8 md:p-12 z-20 text-white max-w-xl">
              ...
              <h2 className="font-display text-3xl md:text-4xl mb-4">{featuredCake.name}</h2>
              ...
              <Button
                ...
                onClick={() => setSelectedProduct(featuredCake)}
              >
                Learn More
              </Button>
            </div>
        ...
        <main className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-8 reveal">
          <div className="flex flex-col md:flex-row justify-between items-baseline mb-12 gap-6 border-b border-outline-variant/20 pb-4">
            <div>
              <h3 className="font-display text-3xl text-primary mb-1">Our Cakes</h3>
            ...
            <div className="flex flex-wrap gap-3 text-sm">
              {[
                ...
                { label: "Anniversary Cakes", value: "anniversary cake" },
                { label: "Sorry Cakes", value: "sorry cakes" },
